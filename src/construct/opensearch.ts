import { aws_opensearchserverless } from "aws-cdk-lib";
...
export class Opensearch extends Construct {
  ...
  constructor(scope: Construct, id: string, props: OpensearchProps) {
    ...
    const collection = new aws_opensearchserverless.CfnCollection(this, "knowledgeBaseCollection", {
    ...
    // 暗号化ポリシーを作成
    const collectionEncryptionPolicy = new aws_opensearchserverless.CfnSecurityPolicy(
      this,
    ...
    // ネットワークセキュリティポリシーを作成
    new aws_opensearchserverless.CfnSecurityPolicy(this, "KnowledgeBaseCollectionNetworkPolicy", {
      name: props.collectionName,
      type: "network",
      policy: JSON.stringify([
        {
    ...
    // アクセスポリシーを作成
    new aws_opensearchserverless.CfnAccessPolicy(this, "KnowledgeBaseCollectionAccessPolicy", {
      name: props.collectionName,
      type: "data",
      policy: JSON.stringify([
        {
          ...
          Principal: [props.bedrockRoleArn, props.customResourceRoleArn],
        },
      ]),
    });
  }
